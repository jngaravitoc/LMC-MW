...
Milky Way and Large Magellanic Cloud model where set up using the
public available code GalIC.
...
There is still no agreement. Due to this disagreement we model 
the Milky Way mass within the range of $1-2 \times ^{10}M_{\odot}$
...
Hernquist profile, we impose the condition that the enclosed mass
...
parameter should be $\sim 30\%$ larger.

The Disk of the Milky Way is modeled using an exponential disk and
...
\hline
\end{tabular}
\caption{Summary of the Milky Way models \& parameters.\lable{tab:MWmodels}}
\end{center}
\end{table}
