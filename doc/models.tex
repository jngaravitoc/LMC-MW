...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{RC_chervins_model.png}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{RC_halo.png}
\includegraphics[scale=0.5]{ME_halo.png}
\end{figure}
...
mass at $9kpc$ is $M(9kpc) = 1.3 \times 10^{10} M_{\odot}$. The
rotations curves and the enclosed mass of all the LMC models are shown
in Fig \ref{fig:LMC_mass}.
